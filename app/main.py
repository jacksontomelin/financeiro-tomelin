...
from .routers import auth, categorias, contas, contatos, lancamentos, dashboard, veiculos, relatorios, configuracoes, usuarios, nfe as nfe_router
...
for r in (auth.router, categorias.router, contas.router, contatos.router,
          ...
          relatorios.router, configuracoes.router, usuarios.router, nfe_router.router, whatsapp_router.router):
